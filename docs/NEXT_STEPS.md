...
## Current Status
FEAT-pipeline complete. 318 tests passing. Ready for FEAT-epub (EPUB output formatter).

## Up Next
- [ ] FEAT-epub: EPUB output formatter (EpubFormatter, build_epub, numeric chapter ordering)
## Completed
